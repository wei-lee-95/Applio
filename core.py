...
def load_voices_data():
    ...
    voices_path = os.path.join(base_dir, "rvc", "lib", "tools", "tts_voices.json")
...
def run_preprocess_script(
    ...
    preprocess_script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..","Applio", "rvc", "train", "preprocess", "preprocess.py"))
    command = [
        python,
...
def run_extract_script(
    ...
    extract = os.path.abspath(os.path.join(os.path.dirname(__file__), "..","Applio", "rvc", "train", "extract", "extract.py"))
...
def run_train_script(
    ...
    train_script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..","Applio", "rvc", "train", "train.py"))
    command = [
        python,
        train_script_path,
        *map(
...
def run_index_script(model_name: str, index_algorithm: str):
    index_script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..","Applio", "rvc", "train", "process", "extract_index.py"))
    command = [
        python,
        index_script_path,
        os.path.join(logs_path, model_name),

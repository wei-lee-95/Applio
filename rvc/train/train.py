...
applio_root = os.path.abspath(os.path.join(current_dir, "../../")) 
experiment_dir = os.path.join(applio_root, "logs", model_name)
...
def main():
    ...
    if cleanup:
        ...
        for root, dirs, files in os.walk(
            os.path.join(applio_root, "logs", model_name), topdown=False
        ):
            for name in files:
